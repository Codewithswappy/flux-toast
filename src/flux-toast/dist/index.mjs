...
import { createContext, memo, useRef, useState, useCallback, useEffect, useContext, useMemo, useSyncExternalStore } from 'react';
import { jsxs, jsx } from 'react/jsx-runtime';
import { useMotionValue, useTransform, motion, AnimatePresence } from 'motion/react';
...
var useToastContext = () => useContext(ToastContext);
...
function NodeLinesPattern() {
  return /* @__PURE__ */ jsx("div", { className: "flux-toast-pattern", "aria-hidden": "true", children: /* @__PURE__ */ jsxs("svg", { width: "100%", height: "100%", children: [
    ...
    /* @__PURE__ */ jsx("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: "url(#node-lines)" })
  ] }) });
}
...
function CloseIcon() {
  return /* @__PURE__ */ jsx(
    "svg",
    {
      ...
      strokeLinecap: "round",
      strokeLinejoin: "round",
      children: /* @__PURE__ */ jsx("path", { d: "M18 6l-12 12M6 6l12 12" })
    }
  );
}
...
var ToastItem = memo(function ToastItem2({
  ...
  return /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(NodeLinesPattern, {}),
        /* @__PURE__ */ jsxs("div", { className: "flux-toast-header", children: [
          (showCustomIcon || IconComponent) && /* @__PURE__ */ jsx("div", { className: "flux-toast-icon-wrapper", "aria-hidden": "true", children: showCustomIcon ? toast2.icon : IconComponent }),
          /* @__PURE__ */ jsx("div", { className: "flux-toast-title-wrapper", children: toast2.content ? toast2.content : toast2.title && /* @__PURE__ */ jsx("div", { className: "flux-toast-title", children: toast2.title }) }),
          toast2.count > 1 && /* @__PURE__ */ jsx(
            motion.span,
            {
          ...
          isExpandable && /* @__PURE__ */ jsx(
            "button",
            {
              ...
              type: "button",
              children: expanded ? /* @__PURE__ */ jsx(ChevronUpIcon, {}) : /* @__PURE__ */ jsx(ChevronDownIcon, {})
            }
          ),
          toast2.dismissible !== false && /* @__PURE__ */ jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsx(AnimatePresence, { initial: false, children: expanded && /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flux-toast-body", children: [
              toast2.description && /* @__PURE__ */ jsx("div", { className: "flux-toast-description", children: toast2.description }),
        ...
        /* @__PURE__ */ jsx(AnimatePresence, { initial: false, children: showTimers && /* @__PURE__ */ jsx(
          motion.div,
          {
            initial: { height: 0, opacity: 0 },
            animate: { height: "auto", opacity: 1 },
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flux-toast-footer", children: [
              /* @__PURE__ */ jsxs("span", { className: "flux-toast-timer-text", children: [
                "This message will close in",
                " ",
                /* @__PURE__ */ jsx("strong", { children: Math.ceil(remainingTime / 1e3) }),
                " seconds."
              ] }),
              /* @__PURE__ */ jsx("button", { className: "flux-toast-stop-btn", onClick: handleStop, children: "Click to stop." })
            ] })
          }
        ) }),
        /* @__PURE__ */ jsx(AnimatePresence, { initial: false, children: showTimers && /* @__PURE__ */ jsx(
...
function ToastViewport({
  ...
  return /* @__PURE__ */ jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "popLayout", initial: false, children: orderedToasts.map((toast2) => /* @__PURE__ */ jsx(
        ToastItem,
        {
          toast: toast2,
          position,
...
export { ToastItem, ToastProvider, ToastViewport, generateId, prefersReducedMotion, toast, toastStore, useToast };
